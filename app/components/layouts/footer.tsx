...
export default function FooterPage() {
    return (
        <Footer className="border-t border-t-[#ccc] rounded-none" container>
      <FooterCopyright className="w-full" href="#" by="Bản quyền thuộc về Phòng Quản trị - Thiết bị" year={2025} />
    </Footer>
